...
Route::post('/cart/update-quantity', [SuchiController::class, 'updateCartQuantity']);
Route::post('/cart/remove', [SuchiController::class, 'removeFromCart']);
Route::get('/help-center', [SuchiController::class, 'helpCenter'])->name('help.center');
Route::post('/help-center/submit', [SuchiController::class, 'submitInquiry'])->name('help.submit');
